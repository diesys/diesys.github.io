...
class InfiniteGridMenu {
  ...
  // Tears down the render loop and the GL context so an unmounted island
  // doesn't leak frames or GPU resources (mirrors Galaxy.tsx cleanup).
  public destroy(): void {
    ...
    <div className="relative h-full w-full">
      ...
      {activeItem && (
        <>
          ...
          >
            <span className="text-paper relative top-[2px] text-[26px] select-none">&#x2197;</span>
          </button>
        </>
      )}
    </div>
